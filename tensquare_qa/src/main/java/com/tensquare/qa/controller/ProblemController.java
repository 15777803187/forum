...
public class ProblemController {
	...
	public Result findNewProblem(@PathVariable("labelId") String labelId,@PathVariable("page") int page,@PathVariable("size") int size){
		return problemService.findNewProblem(labelId,page,size);
	}
	...
	public Result findHotListByLabelId(@PathVariable("labelId") String labelId,@PathVariable("page") int page,@PathVariable("size") int size){
		return problemService.findHotListByLabelId(labelId,page,size);
	}
	...
	public Result findWaitListByLabelId(@PathVariable("labelId") String labelId,@PathVariable("page") int page,@PathVariable("size") int size){
		return problemService.findWaitListByLabelId(labelId,page,size);
	}

	@GetMapping("/label/{id}")
	public Result findLabelById(@PathVariable("id") String labelId){
	...
	public Result findUserProblem(@PathVariable("userid")String userid,@PathVariable("page")int page,@PathVariable("size")int size){
		return problemService.findByUserid(userid,page,size);
	}

	@GetMapping("/state/{page}/{size}")
	public Result findByState(@PathVariable("page")int page,@PathVariable("size")int size){
		return problemService.findByState(page,size);
	}
}

...
public class EnterpriseController {
	...
	@GetMapping("/search/hotlist/{page}/{size}")
	public  Result findIsHot(@PathVariable("page") int page,@PathVariable("size") int size){
		return enterpriseService.findIsHot(page,size);
	}
}
